...
if($_SESSION["login"] != 1)
    ...
    $sql = "insert into Person (p_name,p_phone,p_armyno, p_dob, p_address, p_gender, p_blood_group, p_med_issues) values('$name', '$phone','$ano', '$dob', '$address', '$gender', '$blood_group', '$med_issues')";  
