...
if($_SESSION["login"] != 1)
	...
	$sql = "select r.r_date, r.r_time, r.r_hospital, r.r_quantity, p.p_id, p.p_name,p.p_armyno, p_phone, p.p_blood_group from Person p,Receive r where p.p_id = r.p_id and r.r_date >= '$sdate' and r.r_date <= '$edate'";  
